      ...
      <main className="flex-grow container mx-auto p-4">
        <div className="flex justify-between mb-6">
          {!isAuthenticated ? (
            <>
              <Link href="/signin">
                <button className="flex text-xs sm:text-sm md:text-base items-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition ease-in-out transform hover:scale-105 hover:shadow-lg duration-300">
                  <FiLogIn className="mr-2" /> Sign In
                </button>
              </Link>
              <Link href="/signup">
                <button className="flex text-xs sm:text-sm md:text-base items-center bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded transition ease-in-out transform hover:scale-105 hover:shadow-lg duration-300">
